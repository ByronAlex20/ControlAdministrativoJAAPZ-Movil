...
public class BaseDatos {
    ...
    public static final String TABLA_ANIO = "jun_anio";
    public static final String CREAR_TABLA_ANIO = "CREATE TABLE jun_anio(id_anio integer primary key autoincrement," +
            " descripcion integer, estado varchar(1))";
    public static final String TABLA_BARRIO = "jun_barrio";
    public static final String CREAR_TABLA_BARRIO = "CREATE TABLE jun_barrio( id_barrio integer primary key autoincrement, " +
    ...
    public static final String TABLA_CICLO_FACTURACION = "jun_ciclo_facturacion";
    public static final String CREAR_TABLA_CICLO_FACTURACION = "CREATE TABLE jun_ciclo_facturacion( id_ciclo integer primary key autoincrement, " +
            "id_responsable integer, id_barrio integer, fecha_inicio datetime, fecha_fin datetime, estado varchar(1) )";
    public static final String TABLA_CLIENTE = "jun_cliente";
    public static final String CREAR_TABLA_CLIENTE = "CREATE TABLE jun_cliente( id_cliente integer primary key autoincrement, " +
            "cedula text, nombres text, apellidos text, direccion text, telefono text, foto blob, estado varchar(1), genero text)";
    ...
    public static final String TABLA_CUENTA_CLIENTE = "jun_cuenta_cliente";
    public static final String CREAR_TABLA_CUENTA_CLIENTE = "CREATE TABLE jun_cuenta_cliente( id_cuenta integer primary key autoincrement, " +
            "id_cliente integer, id_categoria integer, id_barrio integer, id_medidor integer, fecha_ingreso datetime, observacion text, " +
            "direccion text, latitud text, longitud text, estado varchar(1) )";
    ...
    public static final String TABLA_DETALLE_PLANILLA = "jun_detalle_planilla";
    public static final String CREAR_TABLA_DETALLE_PLANILLA = "CREATE TABLE jun_detalle_planilla( id_det_planilla integer primary key autoincrement, " +
            "id_planilla integer, id_tipo_rubro integer, id_orden integer, id_det_convenio integer, descripcion text, subtotal float, estado varchar(1) )";
    ...
    public static final String TABLA_MEDIDOR = "jun_medidor";
    public static final String CREAR_TABLA_MEDIDOR = "CREATE TABLE jun_medidor( id_medidor integer primary key autoincrement, " +
            "id_estado_medidor integer, codigo text, marca text, modelo text, foto blob, estado varchar(1) )";
    public static final String TABLA_MES = "jun_mes";
    public static final String CREAR_TABLA_MES = "CREATE TABLE jun_mes( id_mes integer primary key autoincrement, " +
            "descripcion text, estado varchar(1) )";
    ...
    public static final String TABLA_PLANILLA = "jun_planilla";
    public static final String CREAR_TABLA_PLANILLA = "CREATE TABLE jun_planilla( id_planilla integer primary key autoincrement, " +
            "id_cuenta integer, id_anio integer, id_mes integer, usuario_crea text, fecha datetime, " +
            "lectura_anterior integer, lectura_actual integer, consumo_minimo integer, consumo integer, total_pagar float, " +
            "total_letras text, convenio bit, cancelado bit, estado varchar(1) )";
    public static final String TABLA_REGISTRO_FOTOGRAFICO = "jun_registro_fotografico";
    public static final String CREAR_TABLA_REGISTRO_FOTOGRAFICO = "CREATE TABLE jun_registro_fotografico( id_registro_foto integer primary key autoincrement, " +
            "id_tipo_requerimiento integer, id_det_planilla integer, foto blob, nombre_foto text, estado varchar(1) )";
    ...
    public static final String CREAR_TABLA_USUARIO = "CREATE TABLE seg_usuario( id_usuario integer primary key autoincrement, " +
            "id_perfil integer, cedula text, nombres text, apellidos text, direccion text, telefono text, cargo text, " +
            "usuario text, clave text, foto blob, estado varchar(1) )";
}
